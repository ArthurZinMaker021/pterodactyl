...
preflight(){
    output "Pterodactyl Script de Instalaçao"
    output "Copyright © 2021 https://wa.me//+5521984468174"
    output ""
    ...
    if [ "$virt_serv" = "" ]; then
        ...
        output "Virtualization: Xen-HVM on AWS detectada."
        warn "Voce esta criando isto no googlecloud"
        warn "Espere 10 segundos..."
        sleep 10
    else
...
install_options(){
    ...
    output "[1] Instlar Painel ${PANEL}."
    output "[2] Instalar Painel ${PANEL_LEGACY}."
    output "[3] Configurar Node ${WINGS}."
    output "[4] Instalar Deamon ${DAEMON_LEGACY}."
    output "[5] Instalar Painel junto com Node ${PANEL} ${WINGS}."
    output "[6] Instalar Painel junto com Daemon ${PANEL_LEGACY} ${DAEMON_LEGACY}."
    output "[7] SFTP"
